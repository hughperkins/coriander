macro(add_cocl_executable OUTPUT SRCFILE)
    ...
    add_custom_command(
        OUTPUT ${OUTPUT}
        COMMENT "${CMAKE_CURRENT_SOURCE_DIR}/bin/cocl ${SRCFILE} -o ${CMAKE_CURRENT_BINARY_DIR}/${OUTPUT} ${TESTS_COCL_OPTIONS}"
        COMMAND ${CMAKE_CURRENT_SOURCE_DIR}/bin/cocl ${SRCFILE} -o ${CMAKE_CURRENT_BINARY_DIR}/${OUTPUT} ${TESTS_COCL_OPTIONS}
