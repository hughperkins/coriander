...
; <label>:208                                     ; preds = %158, %154, %150, %147, %144, %132, %.noexc33, %.noexc32, %.noexc40, %124, %117, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit29, %_ZNSolsEPFRSoS_E.exit, %.noexc25, %.noexc24, %.noexc47, %94, %87, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit, %71, %70, %48
...
.loopexit:                                        ; preds = %330, %_ZNSolsEPFRSoS_E.exit59, %282, %_ZNSolsEPFRSoS_E.exit59.preheader.preheader
  %lpad.loopexit = landingpad { i8*, i32 }
          cleanup
  br label %212

.loopexit.split-lp:                               ; preds = %_ZNSolsEPFRSoS_E.exit59.1, %299, %296, %.noexc61, %.noexc60, %.noexc70, %267, %260, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit57, %244, %_ZNK5Eigen9GpuDevice6streamEv.exit55, %232, %_ZNK5Eigen9GpuDevice6streamEv.exit, %186, %160
...
_ZN5Eigen16CudaStreamDeviceD2Ev.exit77:           ; preds = %.noexc1.i76, %302
...
; <label>:79                                      ; preds = %77
  ...
  %81 = getelementptr inbounds [5984 x i8], [5984 x i8]* @__opencl_sourcecode, i32 0, i32 0
...
; <label>:7                                       ; preds = %4
  ...
  %9 = getelementptr inbounds [5984 x i8], [5984 x i8]* @__opencl_sourcecode, i32 0, i32 0
