...
define void @_ZN5Eigen8internal15EigenMetaKernelINS_15TensorEvaluatorIKNS_14TensorAssignOpINS_9TensorMapINS_6TensorIfLi3ELi1EiEELi16ENS_11MakePointerEEEKNS_15TensorSlicingOpIKNS_6DSizesIiLi3EEESC_KNS4_INS5_IKfLi3ELi1EiEELi16ES7_EEEEEENS_9GpuDeviceEEEiEEvT_T0_(
    %"struct.Eigen::TensorEvaluator"* byval nocapture readonly align 8, i32) local_unnamed_addr #1 comdat {
...
define void @_ZN10tensorflow12_GLOBAL__N_113SplitOpKernelIfEEvPKT_iiiNS_21CudaDeviceArrayStructIPS2_Li8EEE(
    float* nocapture readonly,
    i32,
    i32,
    i32,
    %"struct.tensorflow::CudaDeviceArrayStruct"* byval nocapture readonly align 8
  ) local_unnamed_addr #4 comdat {
...
; <label>:31:                                     ; preds = %25, %31
  %32 = phi i32 [ %23, %25 ], [ %53, %31 ]
  %33 = sdiv i32 %32, %26
  %34 = srem i32 %32, %26
  %35 = sdiv i32 %34, %3
  %36 = srem i32 %32, %3
  ...
  %40 = load float*, float** %39, align 8, !tbaa !27
  ...
  %51 = getelementptr inbounds float, float* %40, i64 %50
  %52 = bitcast float* %51 to i32*
  store i32 %49, i32* %52, align 4, !tbaa !22
  %53 = add i32 %28, %32
  %54 = icmp slt i32 %53, %17
  br i1 %54, label %31, label %29
}
