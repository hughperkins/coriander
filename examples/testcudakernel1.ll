...
define void @_Z7incrvalPf(float* nocapture %a) #2 {
  %1 = load float, float* %a, align 4, !tbaa !14
  %2 = fadd float %1, 3.000000e+00
  store float %2, float* %a, align 4, !tbaa !14
  ret void
}
...
define void @_Z13someops_floatPf(float* nocapture %data) #3 {
  ...
  %8 = fmul float %4, %2
  %9 = fadd float %7, %8
  store float %9, float* %data, align 4, !tbaa !14
  %10 = tail call float @_Z15our_pretend_logf(float %2)
  %11 = load float, float* %data, align 4, !tbaa !14
  %12 = fadd float %10, %11
  store float %12, float* %data, align 4, !tbaa !14
  %13 = load float, float* %1, align 4, !tbaa !14
  %14 = tail call float @_Z15our_pretend_expf(float %13)
  %15 = load float, float* %data, align 4, !tbaa !14
  %16 = fadd float %14, %15
  store float %16, float* %data, align 4, !tbaa !14
  %17 = load float, float* %1, align 4, !tbaa !14
  %18 = tail call float @_Z16our_pretend_tanhf(float %17)
  %19 = load float, float* %data, align 4, !tbaa !14
  %20 = fadd float %18, %19
  %21 = load float, float* %1, align 4, !tbaa !14
  %22 = fpext float %21 to double
  %23 = tail call double @llvm.nvvm.sqrt.rn.d(double %22) #6
  %24 = fpext float %20 to double
  %25 = fsub double %24, %23
  %26 = fptrunc double %25 to float
  store float %26, float* %data, align 4, !tbaa !14
  ret void
}
...
define void @_Z11someops_intPi(i32* nocapture %data) #2 {
  ...
  %8 = mul nsw i32 %4, %2
  %9 = add nsw i32 %8, %7
  store i32 %9, i32* %data, align 4, !tbaa !18
  ret void
}
...
define void @_Z15testsyncthreadsPf(float* nocapture %data) #2 {
  ...
  store float %5, float* %3, align 4, !tbaa !14
  ...
  store float %10, float* %8, align 4, !tbaa !14
  ret void
}
...
!4 = !{void (float*, i32*)* @_Z13use_template1PfPi, !"kernel", i32 1}
!5 = !{void (float*)* @_Z13someops_floatPf, !"kernel", i32 1}
!6 = !{void (i32*)* @_Z11someops_intPi, !"kernel", i32 1}
!7 = !{void (float*)* @_Z15testsyncthreadsPf, !"kernel", i32 1}
!8 = !{null, !"align", i32 8}
